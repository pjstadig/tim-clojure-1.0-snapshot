...
public class UtilTC {
	...
	static public boolean same(Object k1, Object k2) {
		if (k1 == k2)
			return true;
		if (k1 instanceof Boolean && k2 instanceof Boolean)
			return ((Boolean) k1).booleanValue() == ((Boolean) k2)
					.booleanValue();
		if (k1 instanceof Symbol && k2 instanceof Symbol)
			return k1.equals(k2);
		return false;
	}
