...
public class VarTC extends ARef implements IFn, IRef, Settable {

	static ThreadLocal<Var.Frame> dvals = new ThreadLocal<Var.Frame>() {

		protected Var.Frame initialValue() {
			return new Var.Frame();
		}
	};
	...
	public static final Object NOT_BOUND = new Object();

	public static VarTC intern(Namespace ns, Symbol sym, Object root) {
		return intern(ns, sym, root, true);
	}

	public static VarTC intern(Namespace ns, Symbol sym, Object root,
			boolean replaceRoot) {
		VarTC dvout = (VarTC)(Object)ns.intern(sym);
	...
	public static VarTC create() {
		return new VarTC(null, null);
	}

	public static VarTC create(Object root) {
		return new VarTC(null, null, root);
	}
	...
	public boolean isBound() {
		return hasRoot()
				|| (count.get() > 0 && dvals.get().bindings.containsKey(this));
	}
	...
	public final Object deref() {
		...
		if (hasRoot())
			return root;
		throw new IllegalStateException(String.format("Var %s/%s is unbound.",
				ns, sym));
	}
	...
	public static void pushThreadBindings(Associative bindings) {
		...
		dvals.set(new Var.Frame(bindings, bmap, f));
	}
